...
# 下载地址（请根据实际情况修改）
LINUX_IMAGE_URL="http://your-server/path/to/linux-image-5.4.243+_5.4.243+-1_amd64.deb"
LINUX_HEADERS_URL="http://your-server/path/to/linux-headers-5.4.243+_5.4.243+-1_amd64.deb"
